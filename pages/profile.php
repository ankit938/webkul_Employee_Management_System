...
<body>
    <div class="profile-container">
        ...
        <div class="profile-card">
            ...
            <p><strong>Email:</strong> <?php echo htmlspecialchars($user['email']); ?></p><br><hr><br>
            ...
            <p><strong>Experiences:</strong> <?php echo htmlspecialchars($user['experiences']); ?></p><br><hr><br>
